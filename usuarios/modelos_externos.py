...
class ShopOrderCartItems(models.Model):
    id = models.BigAutoField(primary_key=True)
    order = models.ForeignKey(ShopOrder, models.DO_NOTHING)
    cartitem = models.ForeignKey(ShopCartitem, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'shop_order_cart_items'
        unique_together = (('order', 'cartitem'),)
